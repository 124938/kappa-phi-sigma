...
const CareTaker: React.FC<IProps> = (props) => {
    ...
    return (
        <section className="py-10 bg-gray-100 sm:py-8 bg-slate-950 min-h-screen h-fit">
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl ">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl fontColor">Welcome {postData.caretakerName} !</h2>
                    ...
                    <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900">{postData.phoneNumber}</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900">{postData.caretakerEmail}</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">{postData.address}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="px-6 py-12 sm:p-12">
                            <section className="py-10 bg-gray-100 sm:py-8">
                                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                                    <div className="max-w-2xl mx-auto text-center">
                                        <h3 className="text-3xl font-semibold text-center text-gray-900">Active Patient Information</h3>
                                    </div>
                                    ...
                                    <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
                                        {postData.familyDetailsResponseDTOS && postData.familyDetailsResponseDTOS.map((patient: any, index: any) => {
                                            return (
                                                <div className="overflow-hidden bg-white rounded-md shadow">
                                                    <div className="px-8 py-12">
                                                        <div className="relative w-24 h-24 mx-auto">
                                                            <img className="relative object-cover w-24 h-24 mx-auto rounded-full" src={imageArray[index]} alt="" />
                                                        ...
                                                        <div><span className="mt-1 text-base patient-font">Name : </span><span className="mt-1 text-base text-gray-600">{patient.patientDetails.name}</span></div>
                                                        <div><span className="mt-1 text-base patient-font">Doctor : </span><span className="mt-1 text-base text-gray-600">{patient.patientDetails.doctorName}</span></div>
                                                        <div><span className="mt-1 text-base patient-font">Comment : </span><span className="mt-1 text-base text-gray-600">{patient.patientDetails.medicines[0].comment}</span></div>
                                                        <div><span className="mt-1 text-base patient-font">Medicine name : </span><span className="mt-1 text-base text-gray-600">{patient.patientDetails.medicines[0].name}</span></div>
                                                        <div><span className="mt-1 text-base patient-font">Medicine type : </span><span className="mt-1 text-base text-gray-600">{patient.patientDetails.medicines[0].type}</span></div>
